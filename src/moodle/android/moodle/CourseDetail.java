...
public class CourseDetail extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
        	Log.e("Error 1", e.toString()+"Issue with Course Detail functionality");
        }
	...
	private void getCourseDetails() {
    	...
    	courseDetailList = CourseDetailsListHelper.getInstance(this).populateCourseOverview(coursecontent);
