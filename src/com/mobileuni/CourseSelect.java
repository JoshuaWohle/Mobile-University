...
public class CourseSelect extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			if (user == null
					|| (user != null && user.getSelectedCourseId() == 99999)) {
			...
			ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
					android.R.layout.simple_spinner_dropdown_item, courseItems);

			new AlertDialog.Builder(this)
					.setTitle("Select a Course")
					.setSingleChoiceItems(adapter, checkedItem,
								...
								public void onClick(DialogInterface dialog,
									...
									for (Course course : user.getCourses()) {
										if (item.equalsIgnoreCase(course
												.getShortName()))
											user.setSelectedCourseId(course
													.getId());
									}
			...
			Toast.makeText(getApplicationContext(),
					"You are not enrolled in any courses", Toast.LENGTH_LONG)
					.show();
		}
	}
